        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    Console.Write("Dropping and creating database 'HosJuarezDB' ... ");
                    String sql = "DROP DATABASE IF EXISTS [HosJuarezDB]; CREATE DATABASE [HosJuarezDB]";
